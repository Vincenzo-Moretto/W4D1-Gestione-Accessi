...
export const addAuthor = async (req, res) => {
  ...
  author.avatar = author.avatar
    ? author.avatar
    : "https://https://th.bing.com/th/id/OIP.wEsBe2udHBieFeZVmus8qAHaHk?rs=1&pid=ImgDetMainpicsum.photos/40"; //se l'avatar c'è me lo restituisci così com'è altrimenti mi restituisci la stringa "https://picsum.photos/40"
  try {
...
export const patchAuthor = async (req, res) => {
  //importo il middlware uploadCloudinary
